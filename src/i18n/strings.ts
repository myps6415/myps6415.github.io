  ...
  en: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        "Across previous roles I've shipped on GCP, AWS, and Azure, orchestrating with Airflow, Dagster, and lightweight schedulers, and processed enough data with PySpark, dbt, and BigQuery to know that the right tool is the one that matches the actual requirement — including the team's ability to operate it.",
        ...
        "Currently going deep on LLM-augmented data pipelines and BigQuery Vector Search for editorial workflows.",
      ],
    },
    work: {
      label: "Selected Work",
  ...
  zh: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        "過去幾份工作，GCP、AWS、Azure 都有正式環境的經驗，orchestration 用過 Airflow、Dagster 和輕量的 scheduler，資料處理 PySpark、dbt、BigQuery 都跑過 — 累積下來的心得是：最適合的工具，是「對得上實際需求 + 團隊維護得起來」的那一個，不是當下話題最熱的那一個。",
        "資料建模和基礎建設這兩塊花的時間差不多 — 後者像是讓 token 不會過期、讓 job 保持 idempotent、讓帳單一直停在很小的數字。",
        "現在主力在做 LLM-augmented data pipelines，以及 BigQuery Vector Search 在編輯端的應用。",
      ],
    },
    work: {
      label: "代表作",
